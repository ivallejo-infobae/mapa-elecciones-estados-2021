...
mapMex.mapael({
    ...
    defaultArea: {
      ...
      eventHandlers: {
        click: function (e, id, mapElem, textElem, elemOptions) {
          let attr = elemOptions.attrs.class;
          let key = elemOptions.key;
          if(attr == 'elecciones'){
            // mapMex.trigger('zoom', {
            //   area: id,
            //   areaMargin: 5,
            //   level: 5
            // });
            popup.find("img").attr("src", `img/graficas-estados/${key}.png`)
            popup.fadeIn().addClass('over');
  ...
  areas: {
    "aguascalientes": {
      value: 2,
      tooltip: {content: "Aguascalientes"},
      key: "ags",
    },
    "baja california": {
      value: 1,
    ...
    "san luis potosi": {
      value: 1,
      tooltip: {content: "San Luis Potosí"},
      key: "slp",
      attrs: {
        "class": 'elecciones'
      }
    ...
    "yucatan": {
      value: 2,
      tooltip: {content: "Yucatán"},
      key: "yuc"
    },
    "zacatecas": {
      value: 1,
      tooltip: {content: "Zacataecas"},
      key: "zac",
      attrs: {
        "class": 'elecciones'
      }
